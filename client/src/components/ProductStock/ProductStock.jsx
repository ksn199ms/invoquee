...
//                 className="flex justify-center mb-4 px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 "
//               >
//                 New Product
//               </button>
//               </Link>
...
const ProductStock = () => {
  ...
  return (
    <div className="p-4 sm:p-6 bg-gray-100 min-h-screen">
      <div className="bg-white p-4 sm:p-6 rounded-xl shadow-md">
        ...
        <div className="flex justify-center mb-4">
          <input
            ...
            value={searchTerm}
            onChange={(e) => setSearchTerm(e.target.value)}
            className="border rounded-lg px-4 py-2 w-full max-w-xs sm:max-w-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
            ...
            filteredProducts.map((product) => (
              ...
              >
                ...
                <div className="text-xs text-gray-700">
                  ...
                  <p>
                    <span className="font-medium">Stock:</span> {product.piece}
                  </p>
                  <p>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 z-50">
          <div className="bg-white p-6 rounded-xl w-full max-w-sm sm:max-w-md mx-auto shadow-lg">
            <h2 className="text-lg sm:text-xl font-semibold mb-4">Update Product</h2>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  value={selectedProduct.id}
                  disabled
                  className="border rounded w-full px-3 py-2 bg-gray-100 text-gray-700 text-sm"
                />
              </div>
            ...
            <div className="flex justify-end mt-6 space-x-3">
              ...
              <button
                onClick={handleUpdate}
                className="px-3 sm:px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 text-sm"
              >
                Save
              </button>
            </div>
      ...
      {isConfirmOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 z-50">
          <div className="bg-white p-6 rounded-xl w-full max-w-sm mx-auto shadow-lg">
            <h2 className="text-lg sm:text-xl font-semibold mb-4 text-center">Are you sure?</h2>
            ...
            <div className="flex justify-center space-x-4">
              ...
              <button
                onClick={confirmDelete}
                className="px-3 sm:px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 text-sm"
              >
                Delete
              </button>
            </div>
